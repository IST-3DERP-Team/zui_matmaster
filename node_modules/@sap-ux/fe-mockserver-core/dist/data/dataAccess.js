...
class DataAccess {
    constructor(service, metadata, fileLoader) {
        ...
        this.log = (0, logger_1.getLogger)('server:ux-fe-mockserver');
        ...
        if (rootEntitySet) {
            ...
            if (actionDefinition) {
                ...
                if (targetEntitySet) {
                    ...
                    return (_a = (await mockEntityContainer_1.MockEntityContainer.read(this.mockDataRootFolder, this.fileLoader))) === null || _a === void 0 ? void 0 : _a.executeAction(actionDefinition, Object.assign({}, actionData), odataRequest.queryPath[0].keys || {}, odataRequest);
                }
            }
            else {
                ...
                if (unboundActionDefinition) {
                    ...
                    if (Object.keys(this.stickyEntitySets).length > 0) {
                        ...
                        for (const entitySet of this.stickyEntitySets) {
                            await entitySet.executeAction(unboundActionDefinition, actionData, odataRequest, odataRequest.queryPath[0].keys);
                        }
                    }
                    else if (!targetEntitySet) {
                        // Treat this as a normal unbound action
                        // There is no entitySet linked to it, handle it in the EntityContainer.js potentially as executeAction
                        return (_b = (await mockEntityContainer_1.MockEntityContainer.read(this.mockDataRootFolder, this.fileLoader))) === null || _b === void 0 ? void 0 : _b.executeAction(unboundActionDefinition, Object.assign({}, actionData), odataRequest.queryPath[0].keys || {}, odataRequest);
                    }
                    return true;
                }
                return null;
