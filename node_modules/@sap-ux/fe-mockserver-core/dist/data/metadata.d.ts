import type { Action, ConvertedMetadata, EntitySet, EntityType, NavigationProperty, RawMetadata, Singleton } from '@sap-ux/vocabularies-types';
...
export declare class ODataMetadata {
    ...
    findInDescendant(entitySet: EntitySet | Singleton, targetEntitySet: EntitySet, path: NameAndNav[]): boolean;
