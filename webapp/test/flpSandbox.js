		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zuimatmaster-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuimatmaster-display": {
								"semanticObject": "zuimatmaster",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuimatmaster",
									"url": sap.ui.require.toUrl("zuimatmaster")
								}
							}
						}
					}
