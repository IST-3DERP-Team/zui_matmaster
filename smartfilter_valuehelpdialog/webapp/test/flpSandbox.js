		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Filter Valuehelpdialog",
									"targetURL": "#smartfiltervaluehelpdialog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartfiltervaluehelpdialog-display": {
								"semanticObject": "smartfiltervaluehelpdialog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartfiltervaluehelpdialog",
									"url": sap.ui.require.toUrl("smartfiltervaluehelpdialog")
								}
							}
						}
					}
